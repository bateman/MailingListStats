...
CREATE TABLE mailing_lists (
    mailing_list_url VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL,
    mailing_list_name VARCHAR(255) CHARACTER SET utf8mb4 NULL DEFAULT 'NULL',
...
CREATE TABLE people (
    email_address VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL,
    name VARCHAR(255) CHARACTER SET utf8mb4 NULL,
    username VARCHAR(255) CHARACTER SET utf8mb4 NULL,
    domain_name VARCHAR(255) CHARACTER SET utf8mb4 NULL,
    top_level_domain VARCHAR(255) CHARACTER SET utf8mb4 NULL,
    PRIMARY KEY(email_address))
ENGINE=InnoDB;

CREATE TABLE messages (
    message_id VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL,
    mailing_list_url VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL,
    mailing_list VARCHAR(255) CHARACTER SET utf8mb4 NULL,
    first_date DATETIME NULL,
    first_date_tz INTEGER(11) NULL,
    arrival_date DATETIME NULL,
    arrival_date_tz INTEGER(11) NULL,
    subject VARCHAR(1024) CHARACTER SET utf8mb4 NULL,
    message_body MEDIUMTEXT CHARACTER SET utf8mb4 NULL,
    is_response_of VARCHAR(255) CHARACTER SET utf8mb4 NULL,
    mail_path TEXT CHARACTER SET utf8mb4 NULL,
